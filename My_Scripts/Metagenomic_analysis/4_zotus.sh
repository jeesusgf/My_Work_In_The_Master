...
### 2 - Sort the samples
~/usearch -sortbylength Zotus/zotus100.fa -fastaout Zotus/zotus100_sort.fa -minseqlength 175
...
~/usearch -usearch_local Zotus/zotus.fa -db ~/Documents/BBDD_ambiental/Especifica_16S_ambiental_v9.fasta \
...
~/usearch -sintax Zotus/not_matched.fa -db ~/Documents/BBDD_ambiental/Sintax_16S_ambiental_v9.fasta \
